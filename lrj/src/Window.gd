...
onready var normal_texture = preload("res://assets/textures/ui/window/window.png");
onready var focused_texture = preload("res://assets/textures/ui/window/window_focused.png");
